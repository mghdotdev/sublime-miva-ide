...
def build_comment_data(view, pt):
    ...
    for suffix in suffixes:
        start = all_vars.setdefault("TM_MV_COMMENT_START" + suffix)
        end = all_vars.setdefault("TM_MV_COMMENT_END" + suffix)
        mode = all_vars.setdefault("TM_MV_COMMENT_MODE" + suffix)
        disable_indent = all_vars.setdefault("TM_MV_COMMENT_DISABLE_INDENT" + suffix)
...
class ToggleMvCommentCommand(sublime_plugin.TextCommand):
